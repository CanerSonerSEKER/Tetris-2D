...
public class Piece : MonoBehaviour
{
    ...
    private bool TestWallKicks(int rotationIndex, int rotationDirection)
    {
        ...
        for (int i = 0; i < this._data.wallKicks.GetLength(1); i++)
        {
            Vector2Int translation = this._data.wallKicks[wallKickIndex, i];
    ...
    private int GetWallKickIndex(int rotationIndex, int rotationDirection)
    {
        ...
        return Wrap(wallKickIndex, 0, this._data.wallKicks.GetLength(0));
    }
